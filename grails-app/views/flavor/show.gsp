...
<html>
	...
	<body>
		...
		<div id="show-flavor" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:flavorInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${flavorInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
